...
class TestSherpaOnnxPlugin(unittest.TestCase):
    ...
    def setUp(self):
        ...
        # 获取sherpa_0220_std模型配置
        self.model_config = self.config_manager.get_model_config('sherpa_0220_std')
        self.assertIsNotNone(self.model_config, "未找到sherpa_0220_std模型配置")
    ...
    def test_plugin_initialization(self):
        """测试插件初始化"""
        # 检查插件ID
        self.assertEqual(self.plugin.get_id(), "sherpa_0220_std")
    ...
    def test_plugin_setup(self):
        ...
        self.assertEqual(model_info['engine'], "sherpa_0220_std")
